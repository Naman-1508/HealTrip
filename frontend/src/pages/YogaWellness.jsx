      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-400 max-w-2xl font-light">
            Discover curated yoga and mental health sessions designed to reduce
            stress, improve mental clarity, and support overall well-being
        ...
        <div className="bg-zinc-900/80 backdrop-blur-sm rounded-xl p-6 border border-white/10 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <input
              ...
              placeholder={
                activeTab === "yoga"
                  ? "Focus (e.g., stress, meditation)"
                  : "Type (e.g., anxiety, depression)"
              }
              value={focus}
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-zinc-800">
                  ...
                  <button
                    onClick={() =>
                      navigate("/payment", {
                        state: { type: "wellness", data: session },
                      })
                    }
