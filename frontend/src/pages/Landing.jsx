  ...
  if (isLoaded && isSignedIn) {
    return (
      ...
      >
              ...
              <Link to="/hospitals">
                <SpotlightCard className="p-8 hover:scale-105 transition-transform cursor-pointer">
                  ...
                  <p className="text-zinc-400">
                    Top medical facilities worldwide
                  </p>
                </SpotlightCard>
              </Link>
        ...
        <div
          className="min-w-full h-screen flex-shrink-0 bg-zinc-950 border-l border-white/5"
          style={{ scrollSnapAlign: "start" }}
        >
          <Section className="bg-zinc-950 border-t-0 border-l-0">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <motion.h2 className="text-4xl md:text-6xl font-heading font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-500">
                  Your Health Journey
                </motion.h2>
                <p className="text-xl text-zinc-400 leading-relaxed font-light mb-8">
                  Track your medical history, upcoming appointments, and
        ...
        <div
          className="min-w-full h-screen flex-shrink-0 bg-white border-l border-zinc-200"
          style={{ scrollSnapAlign: "start" }}
        >
            ...
            <div className="text-center max-w-4xl">
              ...
              <div className="flex justify-center gap-6">
                <Link to="/travel">
                  <Button
                    variant="primary"
                    className="px-10 py-5 text-zinc-200 bg-zinc-950 border-none hover:text-white"
                  >
                    Start Planning
                  </Button>
                </Link>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-zinc-400 leading-relaxed font-light">
                Our AI analyzes your data that you input instantly, matching you
                with the India's top specialists. No more waiting. No more
                uncertainty. Just world-class healthcare at your fingertips.
              </p>
            ...
            {[
              {
                ...
                icon: "🧠",
                desc: "Instant analysis of medical reports with 99% accuracy.",
              },
              {
                title: "Trusted Hospitals",
                icon: "🌍",
                desc: "Access to accredited hospitals in 20+ countries.",
              },
              {
                title: "Wellness Travel",
                icon: "🧘",
                desc: "Recover in serenity with curated yoga & spa retreats.",
              },
            ].map((feature, i) => (
