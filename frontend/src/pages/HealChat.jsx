  ...
  const [messages, setMessages] = useState([
    {
      ...
      role: "bot",
      content:
        "Hey buddy! 👋 I'm your Travel Buddy. Tell me what you're looking for (e.g., 'Cancer treatment', 'Yoga in Rishikesh') and I'll find the best packages for you!",
      type: "text",
    },
  ]);
  const { user } = useUser();
    ...
    <div className="relative pt-24 pb-10 min-h-screen bg-zinc-950 flex justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl px-4 flex flex-col h-[85vh]">
        ...
        <SpotlightCard className="flex-1 bg-black/40 backdrop-blur-md border border-white/10 flex flex-col overflow-hidden rounded-2xl relative">
            ...
            {messages.map((msg) => (
              ...
              >
                ...
                >
                  {/* Avatar */}
                  <div
                    className={`w-8 h-8 rounded-full flex-shrink-0 flex items-center justify-center ${msg.role === "user" ? "bg-zinc-800" : "bg-transparent"}`}
                  >
                    {msg.role === "user" ? (
                        ...
                        >
                          ...
                          <div className="p-3">
                            ...
                            <div className="flex justify-between items-center text-xs">
                              ...
                              <button className="bg-white/10 hover:bg-white/20 text-white px-2 py-1 rounded transition">
                                View Plan
                              </button>
                            </div>
                          </div>
          ...
          <form
            onSubmit={handleSend}
            className="p-4 border-t border-white/10 bg-white/5 flex gap-3 items-center"
          >
            <input
              type="text"
              value={input}
