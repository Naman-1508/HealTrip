...
export default function PackageDetails() {
  ...
  const calculateTotal = () => {
    const hotelCost = selectedHotel
      ? selectedHotel.pricePerNight * packageDuration
      : 0;
    const flightCost = selectedFlight
      ? selectedFlight.price * travelers * 2
      : 0; // Round trip
                      ...
                      >
                        <div className="flex justify-between items-center">
                          <div>
                            ...
                            <p className="text-sm text-zinc-400">
                              {formatDuration(flight.duration)} • {flight.stops}{" "}
                              stops
                            </p>
                          </div>
                          <p className="text-lg font-bold text-blue-400">
                            ₹
                            {(flight.price || flight.Price || 0).toLocaleString(
                              "en-IN",
                            )}
                          </p>
                        </div>
                ...
                {loadingHotels ? (
                  ...
                  <div className="text-center py-12 border border-dashed border-zinc-700 rounded-xl">
                    ...
                    <p className="text-zinc-400">
                      No hotels found near {hospitalAddressStr}
                    </p>
                    <button
                      onClick={loadHotels}
                ...
                <div className="bg-zinc-900/80 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <h3 className="text-lg font-bold">
                      Visa Requirements ({visaInfo.country})
                    </h3>
                  </div>
                ...
                <div className="space-y-4 mb-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setPackageDuration(parseInt(e.target.value))
                      }
