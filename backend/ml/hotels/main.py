...
def recommend_hotels(
    ...
    if filtered_df.empty:
        return {"count": 0, "results": [], "message": "No hotels match your budget/star criteria."}
    ...
    if query:
        ...
        results = filtered_df.sort_values(by=['Hotel_Rating', 'Hotel_Price'], ascending=[False, True])
